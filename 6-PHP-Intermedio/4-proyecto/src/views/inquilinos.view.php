                ...
                <table id="inquilinos" class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> ' . $row['estado'] . ' </td>
                            <td> 
                                <a class="btn btn-primary btn-circle btn-sm mr-2" href="inquilino-edit.php?id=' . $row['id'] . '" >
                                ...
                                <a class="btn btn-circle btn-sm btn-danger" onclick="confirmEliminar(' . $row['id'] . ')" >
