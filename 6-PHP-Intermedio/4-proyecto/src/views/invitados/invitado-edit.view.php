    ...
    <main>
        <section id="sec-edit-guests" class="container mt-5 mb-2 col-lg-7 ">
            <div class="d-flex align-items-star container">
                ...
                <p><a id="btn-back" href="./invitados.php">
                        Regresar a invitados</a></p>
            </div>
            <div class=" container p-4 border">
                <h3 class="fw-bold">Editar invitado</h3>
                <p>
                    Ingresa los siguientes datos para crear un invitado, los permisos otorgados dependerán del
                    rol que le asignes y estos puedes modificarlos desde la configuración avanzada.
                </p>

                <!-- FORM: Editar Invitado -->
                <form method='POST'>
                    <fieldset>
                                ...
                                <div class="col">
                                    <div class="form-group mb-3">
                                        ...
                                        <input id="id-number" name="id-number" type="number"
                                            onkeypress="return isNumber(event)" class="form-control mt-1" value=<?php echo $GuestFound["cedula"]; ?>>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group mb-3">
                                        ...
                                        <input id="fullname" name="fullname" type="text" class="form-control mt-1"
                                            value="<?php echo $GuestFound['nombre']; ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div class="form-group mb-3">
                                        ...
                                        <input id="phone" class="form-control mt-1" name="phone" type="text" value=<?php echo $GuestFound["telefono"]; ?>>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group mb-3">
                                        <label for="text">Acceso</label>
                                        <select id="access" class="form-control mt-1" name="access">
                                            <?php if ($GuestFound["acceso"] == "conceder"): ?>
                                                <option value="conceder" selected>Conceder</option>
                                                <option value="denegar">Denegar</option>
                                            <?php else: ?>
                                                <option value="conceder">Conceder</option>
                                                <option value="denegar" selected>Denegar</option>
                                            <?php endif; ?>
                                        </select>
