...
<body>
    ...
    <main>
                ...
                <table id="dt-tbl" class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> ' . $row['acceso'] . ' </td>
                            <td> 
                                <a class="btn btn-circle btn-sm mr-2" href="invitado-edit.php?id=' . $row['id'] . '" >
        ...
        <section id="sec-add-guests" class="container mt-5 mb-2 col-lg-8 d-none">
            <div class="d-flex align-items-star container">
                ...
                <p><a id="btn-back" href="#display-guests">Regresar a invitados</a></p>
            </div>
            <div class=" container p-4 border">
                <h3 class="fw-bold">Agregar invitado</h3>
                <p>
                                ...
                                <div class="col">
                                    <div class="form-group mb-3">
                                        ...
                                        <span id="text1HelpBlock" class="form-text text-muted">
                                            Indicar si el invitado puede ingresar o no.
                                        </span>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        const confirmEliminar = (pId) => {
            if (confirm("¿Está seguro que desea eliminar al usuario " + pId + " ?")) {
                window.location.href = "./invitado-delete.php?id=" + pId;
            }
        }
    </script>
    ...
    <script src="./assets/js/invitados.jquery.js"></script>
