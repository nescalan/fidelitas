    ...
    <div class="row p-5">
        ...
        <table id="clientes" class="table table-bordered table-hover">
            ...
            <tr>
                ...
                <td> ' . $fila["Telefono"] . ' </td>
                <td> 
                  <a href="editarRegistro.php?id=' . $fila['id'] . '" class="btn btn-dark" >Editar</a> 
                  <button class="btn btn-danger" onclick="confirmEliminar(' . $fila['id'] . ')" >Eliminar</button> 
                  <a href="cambiaContra.php?id=' . $fila['id'] . '" class="btn btn-dark" >Cambiar Contraseña</a> 
                </td>
            </tr>
            ';
                }
