...
<body class="u-body u-xl-mode" data-lang="en">
    ...
    <section class="u-align-center u-clearfix u-grey-5 u-section-1" id="carousel_9e24">
        <div class="u-clearfix u-sheet u-sheet-1">
            <img class="u-expanded-width u-image u-image-default u-image-1" src="./public/img/2.png" alt=""
                data-image-width="1620" data-image-height="1080">
            <div class="u-align-left u-border-16 u-border-no-bottom u-border-no-right u-border-no-top u-border-palette-1-base u-container-style u-expanded-width u-group u-white u-group-1"
                data-animation-name="customAnimationIn" data-animation-duration="1500">
                <div class="u-container-layout u-valign-middle u-container-layout-1">
                    <h5 class="u-text u-text-1">6 de agosto de 2023</h5>
                    <h2 class="u-custom-font u-font-montserrat u-text u-text-default u-text-2">
                        How to Install PHP 8 on Ubuntu 20.04
                    </h2>
                    <p class="u-text u-text-3">
                        PHP is arguably one of the most widely used server-side programming languages. It’s the language
                        of choice when developing dynamic and responsive websites. In fact, popular CM platforms such as
                        WordPress, Drupal, and Magento are based on PHP. Some other notable benefits of using PHP
