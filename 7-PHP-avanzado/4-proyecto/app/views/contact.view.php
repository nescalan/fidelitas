...
<body class="u-body u-xl-mode" data-lang="en">
          ...
          <div class="u-align-left u-expanded-width-xs u-form u-form-1">
            <form action="https://forms.nicepagesrv.com/v2/form/process"
              ...
              <div class="u-form-group u-label-top">
                ...
                <input type="text" placeholder="Ingrese su nombre" id="name-5a14" name="name"
                  class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle"
                  required="required">
              </div>
              <div class="u-form-email u-form-group u-label-top">
                <label for="email-5a14" class="u-label" wfd-invisible="true">Correo</label>
                <input type="email" placeholder="Ingrese un correo válido" id="email-5a14" name="email"
                  class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle"
                  required="">
              </div>
              <div class="u-form-group u-form-message u-label-top">
                <label for="message-5a14" class="u-label" wfd-invisible="true">Mensaje</label>
                <textarea placeholder="Redacte el mensaje" rows="4" cols="50" id="message-5a14" name="message"
                  class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle"
                  required=""></textarea>
              </div>
        ...
        <div class="u-repeater u-repeater-1">
          <div class="u-align-left u-container-style u-list-item u-palette-5-dark-3 u-repeater-item u-list-item-1">
            <div class="u-container-layout u-similar-container u-valign-top u-container-layout-2">
              <h5 class="u-text u-text-default u-text-2"><span class="u-icon u-icon-1"><svg class="u-svg-content"
                    viewBox="0 0 513.64 513.64" x="0px" y="0px" style="width: 1em; height: 1em;">
                    <g>
                      <g>
                        <path
              ...
              <p class="u-text u-text-3">+506 2253-0853</p>
            </div>
          </div>
          <div class="u-align-left u-container-style u-list-item u-palette-5-dark-3 u-repeater-item u-list-item-2">
            <div class="u-container-layout u-similar-container u-valign-top u-container-layout-3">
              <h5 class="u-text u-text-default u-text-4"><span class="u-icon u-icon-2"><svg class="u-svg-content"
              ...
              <p class="u-text u-text-5">Calles 25 y 27, avenida 0 Bis,<br>San Pedro - Montes de Oca
              </p>
            </div>
          </div>
          <div class="u-align-left u-container-style u-list-item u-palette-5-dark-3 u-repeater-item u-list-item-3">
            <div class="u-container-layout u-similar-container u-valign-top u-container-layout-4">
              <h5 class="u-text u-text-default u-text-6"><span class="u-icon u-icon-3"><svg class="u-svg-content"
                    viewBox="0 0 512 512" style="width: 1em; height: 1em;">
                    <g>
                      <path
                        d="m256 0c-140.61 0-256 115.39-256 256s115.39 256 256 256 256-115.39 256-256-115.39-256-256-256zm127.28 107.509 21.211 21.211-21.211 21.211-21.211-21.211zm-66.518-37.412 27.715 11.484-11.47 27.715-27.715-11.484zm134.238 185.903c0 107.52-87.48 195-195 195s-195-87.48-195-195 87.48-195 195-195h15v60h-30v-29.326c-78.968 7.148-141.317 70.387-148.568 149.326h28.568v30h-29.24c7.165 79.021 70.219 142.075 149.24 149.24v-29.24h30v28.568c78.939-7.251 142.178-69.6 149.326-148.568h-29.326v-30h60zm-180-105v111.211l-94.395 94.395-21.211-21.211 85.606-85.606v-98.789zm143.188 55.708-11.484-27.715 27.715-11.47 11.484 27.715z">
                      </path>
                    </g>
                  </svg></span>&nbsp;Horario
              </h5>
              <p class="u-text u-text-7">Lunes a Viernes:<br>8:00 am - 5:00 pm
              </p>
            </div>
          </div>
        </div>
  ...
  <footer class="u-align-center u-clearfix u-footer u-grey-80 u-footer" id="sec-489f">
    <div class="u-clearfix u-sheet u-sheet-1">
      <p class="u-small-text u-text u-text-variant u-text-1">Copyright&nbsp;© 2023 - Ing. Nelson GE.</p>
    </div>
  </footer>
